...
| User Story Title | User Story Body |
| --- | --- |
| 8.5. Feature: Static Frontend Deployment to Walrus (DAT-08.5) | User Story: As a user, I want to access the ticketing application via Walrus Sites, so that the platform has decentralized hosting.<br><br>**Actions:**<br>- Ensure Next.js exports static assets: `output: 'export'` in next.config.js<br>- Test all client-side routes work as static files<br>- Verify SPA routing compatibility<br>- Document deployment process using `walrus sites publish` CLI<br><br>**Deliverables:**<br>- Static SPA build configuration (Next.js `output: 'export'`)<br>- Deployment documentation and testing report |
...
| Feature | ID | Status |
|---------|----|----|--------|
| Decentralized Media Storage | DAT-08.1 | Not Started |
| User Data Deletion | DAT-08.4 | Not Started |
| Static Frontend Deployment to Walrus | DAT-08.5 | Not Started |
| Per-Event Walrus Sites Infrastructure | DAT-08.6 | Not Started |
| Permanent Event Data Archival | DAT-08.7 | Not Started |
